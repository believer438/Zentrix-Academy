    ...
    <div className="min-h-screen bg-white font-sans text-slate-800 overflow-x-hidden">
      ...
      <div className="bg-[#0f0f1a] text-white/70 py-2 px-4 md:px-8 text-xs flex justify-between items-center z-50 relative">
        <div className="flex items-center gap-6">
          <a href="mailto:info@zati.africa" className="flex items-center gap-1.5 hover:text-[#FF6B00] transition-colors duration-300">
      ...
      <header className={`sticky top-0 z-40 w-full transition-all duration-400 ${isScrolled ? 'bg-white shadow-xl py-2 border-b-2 border-[#FF6B00]' : 'bg-white/98 py-3'}`}>
        <div className="container mx-auto px-4 md:px-8 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 z-50">
            <img src="https://zati.africa/wp-content/uploads/2024/10/zentrix-logo-1-193-x-193-px.svg" alt="ZATI Logo" className="h-10 w-10 object-contain" />
          </Link>
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="px-6 py-4 flex flex-col gap-1">
                ...
                <div className="pt-4">
                  <a href="https://bit.ly/zati2025" target="_blank" rel="noopener noreferrer" className="block w-full bg-[#FF6B00] text-white text-center py-3 font-bold tracking-wide">
                    APPLY NOW
                  </a>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            <SlideInLeft>
              ...
              <p className="text-slate-500 mb-4 leading-relaxed text-sm">
                ZATI is Africa's leading continuous learning platform — designed for working professionals, career-switchers, and lifelong learners who want to stay ahead in a rapidly evolving tech landscape.
              </p>
      ...
      <section className="py-0 bg-white border-b border-slate-200">
        <StaggerContainer className="container mx-auto px-4 md:px-16 grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
          {[
            { title: "Learner News", desc: "Stay updated with the latest from the ZATI learning community." },
        ...
        <div className="container mx-auto px-4 md:px-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <FadeUp className="col-span-1">
              ...
              <p className="text-xs text-slate-500 mb-6 leading-relaxed">
                ZATI is Africa's leading continuous learning platform — empowering professionals and learners to grow their skills, advance their careers, and thrive in the digital economy.
              </p>
            ...
            <FadeUp delay={0.3}>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center gap-3 text-xs">
                  ...
                  <a href="mailto:info@zati.africa" className="text-slate-500 hover:text-white transition-colors">info@zati.africa</a>
                </li>
              </ul>
            </FadeUp>
          </div>
          ...
          <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-600 text-xs">
              &copy; {new Date().getFullYear()} Zentrix Africa Technology Institute (ZATI). All Rights Reserved.
            </p>
